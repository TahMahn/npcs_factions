class cfgPatches
{
  class NPC_Skandi_Alliance
  {
    ...
    requiredVersion=0.1;
    requiredAddons[]={"cTab","ace_medical_treatment","A3_Weapons_F","niaweapons_226","rhsgref_c_troops","po_factions_eu","A3_Characters_F","A3_Weapons_F_Items","hlcweapons_g3","A3_Drones_F_Weapons_F_Gamma_Items","A3_Weapons_F_Exp","rhsusf_c_weapons","hlcweapons_SAW","hlcweapons_MG3s","rhsusf_c_troops","hlcweapons_SCAR","hlcweapons_mp5","rhs_c_troops"};
  };
};
...
class cfgVehicles
{
  ...
  class NPC_SC_Commander: I_soldier_F
  {
    ...
    items[]={"ItemcTab","ACE_fieldDressing","ACE_packingBandage","ACE_morphine","ACE_tourniquet","ACE_fieldDressing","ACE_packingBandage","ACE_morphine","ACE_tourniquet"};
    respawnItems[]={"ItemcTab","ACE_fieldDressing","ACE_packingBandage","ACE_morphine","ACE_tourniquet","ACE_fieldDressing","ACE_packingBandage","ACE_morphine","ACE_tourniquet"};
  ...
  class NPC_SC_2IC: I_soldier_F
  {
    ...
    items[]={"ItemcTab","FirstAidKit","FirstAidKit"};
    respawnItems[]={"ItemcTab","FirstAidKit","FirstAidKit"};
  ...
  class NPC_SC_Squad_Lead: I_soldier_F
  {
    ...
    items[]={"ItemAndroid","ItemcTabHCam"};
    respawnItems[]={"ItemAndroid","ItemcTabHCam"};
  ...
  class NPC_SC_Team_lead: I_soldier_F
  {
    ...
    items[]={"ItemAndroid","ItemcTabHCam","FirstAidKit","FirstAidKit"};
    respawnItems[]={"ItemAndroid","ItemcTabHCam","FirstAidKit","FirstAidKit"};
  ...
  class NPC_SC_Medic: I_soldier_F
  {
    ...
    items[]={"ItemcTabHCam","ItemAndroid","FirstAidKit","FirstAidKit","Medikit","FirstAidKit","FirstAidKit","FirstAidKit","FirstAidKit","FirstAidKit","FirstAidKit","FirstAidKit","FirstAidKit","FirstAidKit","FirstAidKit","FirstAidKit","FirstAidKit"};
    respawnItems[]={"ItemcTabHCam","ItemAndroid","FirstAidKit","FirstAidKit","Medikit","FirstAidKit","FirstAidKit","FirstAidKit","FirstAidKit","FirstAidKit","FirstAidKit","FirstAidKit","FirstAidKit","FirstAidKit","FirstAidKit","FirstAidKit","FirstAidKit"};
  ...
  class NPC_SC_Grenadier: I_soldier_F
  {
    ...
    items[]={"ItemcTabHCam","ItemAndroid","FirstAidKit","FirstAidKit"};
    respawnItems[]={"ItemcTabHCam","ItemAndroid","FirstAidKit","FirstAidKit"};
  ...
  class NPC_SC_Autorifleman: I_soldier_F
  {
    ...
    items[]={"ItemcTabHCam","ItemAndroid","FirstAidKit","FirstAidKit","FirstAidKit","FirstAidKit"};
    respawnItems[]={"ItemcTabHCam","ItemAndroid","FirstAidKit","FirstAidKit","FirstAidKit","FirstAidKit"};
  ...
  class NPC_SC_Explosive_Specialist: I_soldier_F
  {
    ...
    weapons[]={"NPC_rhs_weap_hk416d10_rhsusf_acc_SFMB556hlc_acc_DBALPL_side_FLHLC_optic_Aimpoint5000","Put","Throw"};
    respawnWeapons[]={"NPC_rhs_weap_hk416d10_rhsusf_acc_SFMB556hlc_acc_DBALPL_side_FLHLC_optic_Aimpoint5000","Put","Throw"};
    items[]={"ItemcTabHCam","ItemAndroid","FirstAidKit","FirstAidKit","MineDetector","ToolKit"};
    respawnItems[]={"ItemcTabHCam","ItemAndroid","FirstAidKit","FirstAidKit","MineDetector","ToolKit"};
  ...
  class NPC_SC_Engineer: I_soldier_F
  {
    ...
    weapons[]={"NPC_hlc_rifle_g3a3v","Put","Throw"};
    respawnWeapons[]={"NPC_hlc_rifle_g3a3v","Put","Throw"};
    items[]={"ItemcTabHCam","ItemAndroid","FirstAidKit","FirstAidKit","ToolKit","MineDetector"};
    respawnItems[]={"ItemcTabHCam","ItemAndroid","FirstAidKit","FirstAidKit","ToolKit","MineDetector"};
    magazines[]={"SmokeShell","SmokeShell","SmokeShellRed","SmokeShellGreen","SmokeShellBlue","HandGrenade","HandGrenade","hlc_20rnd_762x51_T_G3","hlc_20rnd_762x51_T_G3","hlc_20rnd_762x51_T_G3","hlc_20rnd_762x51_T_G3","hlc_20rnd_762x51_T_G3","hlc_20rnd_762x51_T_G3"};
    respawnMagazines[]={"SmokeShell","SmokeShell","SmokeShellRed","SmokeShellGreen","SmokeShellBlue","HandGrenade","HandGrenade","hlc_20rnd_762x51_T_G3","hlc_20rnd_762x51_T_G3","hlc_20rnd_762x51_T_G3","hlc_20rnd_762x51_T_G3","hlc_20rnd_762x51_T_G3","hlc_20rnd_762x51_T_G3"};
